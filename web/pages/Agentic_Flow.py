...
<body>
  <div class="container">
    ...
    <div class="legend-container">
      ...
      <div class="legend-item">
        <div class="legend-color-box" style="background-color: #FFFFFF; border: 2px solid #FF5A50; border-radius: 5px;">
        </div>
        <div>Crew Method</div>
      </div>
      ...
      <div class="legend-item">
        <div class="legend-color-box"
          style="background-color: #333333; border: 2px dashed #FF5A50; border-radius: 5px;"></div>
        <div>Router</div>
      </div>
  ...
  <script type="text/javascript">
    ...
    function drawGraph() {
      ...
      nodes = new vis.DataSet([{ "color": "#FF5A50", "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "read_table_description", "label": "Read Table Description", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "x": 0.0, "y": 0 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#FFFFFF", "border": "#FF5A50" }, "fixed": true, "font": { "color": "#000000", "multi": "html" }, "id": "generate_sql_query", "label": "Formulate Data Request", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": false }, "x": 0.0, "y": 150 }, { "color": "#333333", "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "run_sql_query", "label": "Retrieve Data", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "x": 0.0, "y": 300 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#333333", "border": "#FF5A50", "highlight": { "background": "#333333", "border": "#FF5A50" } }, "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "handle_query_routing", "label": "Manage Query Flow", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": [5, 5] }, "x": 0.0, "y": 450 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#FFFFFF", "border": "#FF5A50" }, "fixed": true, "font": { "color": "#000000", "multi": "html" }, "id": "generate_sql_interpretation", "label": "Summarize data findings", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": false }, "x": 0.0, "y": 600 }]);
      edges = new vis.DataSet([{ "arrows": "to", "color": "#666666", "dashes": false, "from": "read_table_description", "smooth": { "type": "continuous" }, "to": "generate_sql_query", "width": 2 }, { "arrows": "to", "color": "#666666", "dashes": false, "from": "generate_sql_query", "smooth": { "roundness": 0.2, "type": "continuous" }, "to": "run_sql_query", "width": 2 }, { "arrows": "to", "color": "#666666", "dashes": false, "from": "run_sql_query", "smooth": { "roundness": 0.2, "type": "continuous" }, "to": "handle_query_routing", "width": 2 }, { "arrows": "to", "color": "#FF5A50", "dashes": true, "from": "handle_query_routing", "smooth": { "roundness": 0.2, "type": "curvedCCW" }, "to": "generate_sql_interpretation", "width": 2 }, { "arrows": "to", "color": "#FF5A50", "dashes": true, "from": "handle_query_routing", "smooth": { "roundness": 0.30000000000000004, "type": "curvedCCW" }, "to": "generate_sql_query", "width": 2 }]);
...
<body>
  ...
  <script type="text/javascript">
    ...
    function drawGraph() {
      ...
      // parsing and collecting nodes and edges from the python
      nodes = new vis.DataSet([{ "color": "#FF5A50", "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "read_table_description", "label": "Read Table Description", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "x": 0.0, "y": 0 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#FFFFFF", "border": "#FF5A50" }, "fixed": true, "font": { "color": "#000000", "multi": "html" }, "id": "generate_construction_query", "label": "Formulate Data Request", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": false }, "x": 0.0, "y": 150 }, { "color": "#333333", "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "run_construction_query", "label": "Fulfill Data Request", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "x": 0.0, "y": 300 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#333333", "border": "#FF5A50", "highlight": { "background": "#333333", "border": "#FF5A50" } }, "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "handle_query_routing", "label": "Validate Outcome", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": [5, 5] }, "x": 0.0, "y": 450 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#FFFFFF", "border": "#FF5A50" }, "fixed": true, "font": { "color": "#000000", "multi": "html" }, "id": "generate_construction_interpretation", "label": "Generate Insights	", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": false }, "x": -150.0, "y": 600 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#FFFFFF", "border": "#FF5A50" }, "fixed": true, "font": { "color": "#000000", "multi": "html" }, "id": "analyze_construction_error", "label": "Diagnose Request Failure", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": false }, "x": 150.0, "y": 600 }]);
      edges = new vis.DataSet([{ "arrows": "to", "color": "#666666", "dashes": false, "from": "read_table_description", "smooth": { "type": "continuous" }, "to": "generate_construction_query", "width": 2 }, { "arrows": "to", "color": "#666666", "dashes": false, "from": "analyze_construction_error", "smooth": { "roundness": 0.2, "type": "continuous" }, "to": "generate_construction_query", "width": 2 }, { "arrows": "to", "color": "#666666", "dashes": false, "from": "generate_construction_query", "smooth": { "roundness": 0.2, "type": "continuous" }, "to": "run_construction_query", "width": 2 }, { "arrows": "to", "color": "#666666", "dashes": false, "from": "run_construction_query", "smooth": { "roundness": 0.2, "type": "continuous" }, "to": "handle_query_routing", "width": 2 }, { "arrows": "to", "color": "#FF5A50", "dashes": true, "from": "handle_query_routing", "smooth": { "roundness": 0.30000000000000004, "type": "curvedCCW" }, "to": "generate_construction_interpretation", "width": 2 }, { "arrows": "to", "color": "#FF5A50", "dashes": true, "from": "handle_query_routing", "smooth": { "roundness": 0.2, "type": "curvedCW" }, "to": "analyze_construction_error", "width": 2 }]);
...
<body>
  ...
  <script type="text/javascript">
    ...
    function drawGraph() {
      ...
      // parsing and collecting nodes and edges from the python
      nodes = new vis.DataSet([{ "color": "#FF5A50", "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "read_table_description", "label": "Read Table Description", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "x": 0.0, "y": 0 }, { "color": "#333333", "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "run_sql_query", "label": "Retrieve Requested Data", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "x": 0.0, "y": 150 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#333333", "border": "#FF5A50", "highlight": { "background": "#333333", "border": "#FF5A50" } }, "fixed": true, "font": { "color": "#FFFFFF", "multi": "html" }, "id": "handle_query_routing", "label": "Validate Results", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": [5, 5] }, "x": 0.0, "y": 300 }, { "borderWidth": 3, "borderWidthSelected": 4, "color": { "background": "#FFFFFF", "border": "#FF5A50" }, "fixed": true, "font": { "color": "#000000", "multi": "html" }, "id": "generate_sql_interpretation", "label": "Summarize Findings", "margin": { "bottom": 8, "left": 10, "right": 10, "top": 10 }, "physics": false, "shape": "box", "shapeProperties": { "borderDashes": false }, "x": 0.0, "y": 450 }]);
      edges = new vis.DataSet([{ "arrows": "to", "color": "#666666", "dashes": false, "from": "read_table_description", "smooth": { "type": "continuous" }, "to": "run_sql_query", "width": 2 }, { "arrows": "to", "color": "#666666", "dashes": false, "from": "run_sql_query", "smooth": { "type": "continuous" }, "to": "handle_query_routing", "width": 2 }, { "arrows": "to", "color": "#FF5A50", "dashes": true, "from": "handle_query_routing", "smooth": { "type": "continuous" }, "to": "generate_sql_interpretation", "width": 2 }]);
...
elif page == "Real Estate Flow":
    components.html(html_code_3, height=800, scrolling=True)
